    ...
    async function generateAnswer(e) {
        ...
        try {
            const response = await axios({
                url: `https://generativelanguage.googleapis.com/v1beta/models/gemini-pro:generateContent?key=${process.env.REACT_APP_OPENAI_API_KEY
                    }`,
                method: "post",
                data: {
    ...
    return (
        <div className="chatbot-container">
            ...
            <div className="chatbot-history" ref={chatHistoryRef}>
                {messageHistory.length === 0 ? ( // Check if messageHistory is empty
                    <h2 className="no-chats-message">Need help?<br />
                    Our bot is here to answer your queries.<br />
                    Just start chatting!</h2> // Display message if empty
                ) : (
